...
$cart=\App\ProductCart::where('web_user_id',$web_user_id)->get();
//print_r($cart) ; exit;
 ?>
		...
		<table width="90%" border="0" cellspacing="0" cellpadding="0">
                ...
                "cellpadding="0" cellspacing="0" border="0" >
                    ...
                    <tbody> <?php  $total=0;  $tot_qty=0; $tot_price=0; $tot_delivery=0; $i=1;  ?>
                         @foreach ($cart as $ct)
                          ...
                          <td cellpadding="0" cellspacing="0"  style="text-align:right;border: 1px dashed #a0a0a0;margin: 20px;font-size: 16px;line-height: 20px;" class="price"><span>{{number_format($ct->delivery_charge ,2)}}</span></td>
            ...
            <td align="center">
                <div cellpadding="0" cellspacing="0"  style="line-height: 24px;">
                	<br>
                 	<h3>   Quantity:<?php echo $tot_qty;?> , <strong style="color:#f70546;">Total Price: Rs.{{ number_format($tot_price+$tot_delivery,2)}}</strong></h3>
