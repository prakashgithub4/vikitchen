...
<input type="text" value="{{$pcode->name}}" name="name" id="name"class="form-control " required    >

<div class="form-group">
    <label for="cars">
        Amount:</label>

<input type="text" value="{{$pcode->amount}}" class="form-control " required name="amount"  id="amount" required>
</div>
<div class="form-group">
    <label for="cars">Max discount:</label>
<input type="text" value="{{$pcode->max_discount}}" name="max_discount" class="form-control " id="max_discount" required>
</div>
<div class="form-group">
    <label for="cars">Discount percentage:</label>
<input type="text" value="{{$pcode->dis_percentage}}" name="dis_percentage" class="form-control " required >
</div>
{{-- <div class="form-group">
...
<div class="form-group">
    @if($pcode->active==1)
<input type="checkbox" id="active" name="active" value="1"  class="form-control" checked>
@else
