...
! function(e) {
    "use strict";
    var a, t, i, s, o, n, r, l, d, c, p, u, m, v, h, g, f, w, C, y, b, k, x, I, S, _, T, P, z, H, q, O, D, M, W, j, A, B, U = e(window),
        E = e(document),
        L = parseInt(991, 10),
        R = e("body");
    U.on("load", function() {
        ...
        function() {
        ...
        }(), a = e("#header, .header").attr("data-header-hover"), t = e("#header, .header"), "true" === a ? e(t).addClass("header-hover") : e(t).removeClass("header-hover"), i = e(".nav-menu > ul > li"), s = e(".nav-dropdown"), o = e(".nav-menu-item"), n = e(".menu-mobile-btn"), r = e(".nav-menu"), e('.nav-dropdown .row [class*="col-"] figure').siblings("img").addClass("themeshot-img"), e(".nav-menu > ul > li:has( > .nav-dropdown)").prepend('<span class="menu-dropdown-icon"></span>'), e(".nav-dropdown > ul > li:has( > .nav-dropdown-sub)").addClass("sub-dropdown-icon"), e(".nav-menu > ul > li:has( > .nav-dropdown)").addClass("dd-menu-dropdown-icon"), U.on("resize", function() {
            e(window).width() > L && e(".nav-dropdown > ul > li ul li:has(.nav-dropdown-sub)").addClass("sub-dropdown-icon"), e(window).width() <= L && e(".nav-dropdown > ul > li ul li:has(.nav-dropdown-sub)").removeClass("sub-dropdown-icon")
        }), E.ready(function() {
        ...
        }), l = e(".dropdown--trigger"), d = e(".dropdown--menu"), c = "trigger--active", p = "dropdown--active", u = "parent--active", m = function() {
            d.removeClass(p), d.siblings(l).removeClass(c), d.parent().removeClass(u)
        }, l.append("<i class='dropdown--trigger-arrow fa fa-angle-down'></i>"), l.on("click", function(a) {
            a.stopPropagation(), e(this).hasClass(c) ? (e(this).removeClass(c), e(this).siblings(d).removeClass(p), e(this).parent().removeClass(u)) : (l.removeClass(c).siblings(d).removeClass(p).parent().removeClass(u), e(this).addClass(c), e(this).siblings(d).addClass(p), e(this).parent().addClass(u))
        ...
        }), v = e(".search-menu-btn"), h = e(".searchbar-menu"), g = e(".search-close-icon"), f = "active", w = "search-menu-open", C = "search-active", y = function() {
            h.removeClass(w), v.removeClass(f), v.parent().removeClass(C)
        }, v.on("click", function(a) {
            a.stopPropagation(), e(this).hasClass(f) ? (e(this).removeClass(f), h.removeClass(w), e(this).parent().removeClass(C)) : (v.removeClass(f).parent().removeClass(C), h.removeClass(w), e(this).addClass(f), h.addClass(w), e(this).parent().addClass(C), setTimeout(function() {
            ...
            y()
        }), b = e(".cart-sidebar-btn"), k = e(".cart-sidebar-menu"), x = e(".close-cart-sidebar"), I = "active", S = "cart-sidebar-open", _ = "cart-active", T = function() {
            R.removeClass(S), b.removeClass(I), b.parent().removeClass(_)
        }, b.on("click", function(a) {
            a.stopPropagation(), e(this).hasClass(I) ? (e(this).removeClass(I), R.removeClass(S), e(this).parent().removeClass(_)) : (b.removeClass(I).parent().removeClass(_), R.removeClass(S), e(this).addClass(I), R.addClass(S), e(this).parent().addClass(_))
            ...
            rotaterator: function(a) {
                ...
                return a = e.extend(t, a), this.each(function() {
                    var t = a,
                        i = e(this);
                    if (e(i.children(), i).each(function() {
                            e(this).hide()
                        }), t.child) s = t.child;
                    else var s = e(i).children(":first");
                    e(s).fadeIn(t.fadeSpeed, function() {
                        e(s).delay(t.pauseSpeed).fadeOut(t.fadeSpeed, function() {
                            var a = e(this).next();
                            0 == a.length && (a = e(i).children(":first")), e(i).rotaterator({
                                child: a,
            ...
            e(".offer-hignlight").rotaterator({
                fadeSpeed: parseInt(500, 10),
                pauseSpeed: parseInt(3e3, 10)
            })
            ...
            e("#newsletter-popup .newsletter-close, #newsletter-popup .newsletter-close-text").on("click", function() {
                e("#newsletter-popup").fadeOut(), e("#active-newsletter-popup").fadeOut()
            });
            var a = e.cookie("visits") || 0;
            if (a++, e.cookie("visits", a, {
                    expires: 1,
                    path: "/"
                }), e.cookie("visits") > parseInt(1, 10)) e("#active-newsletter-popup").hide(), e("#newsletter-popup").hide();
            else {
                var t = E.height();
                e('<div id="active-newsletter-popup"></div>').appendTo("body"), e("#active-newsletter-popup").css("height", t), e("#newsletter-popup").show()
            }
            e.cookie("noShowWelcome") && (e("#newsletter-popup").hide(), e("#active-newsletter-popup").hide())
            ...
            var t = e(this),
                ...
                s = "header--dark",
                o = "header--light";
            if (t.on("initialized.owl.carousel translated.owl.carousel refreshed.owl.carousel", function(a) {
        ...
        function() {
            ...
            a.slick({
                ...
                nextArrow: '<i class="fa fa-angle-right slick-next"></i>',
                prevArrow: '<i class="fa fa-angle-left slick-prev"></i>'
            }), e(".product-media-thumb-slider .slick-slide").removeClass("slick-active"), e(".product-media-thumb-slider .slick-slide").eq(0).addClass("slick-active"), a.on("beforeChange", function(a, t, i, s) {
                var o = s;
            ...
            e(this).css("background-image", 'url("' + a + '")').css("background-position-x", t).css("background-position-y", i)
        }), P = e(".filter-menu-btn"), z = e(".filterbar-dropdown-menu"), H = e(".filter-close-icon"), q = "active", O = "filter-dropdown-menu-open", D = "filter-active", P.on("click", function(a) {
            a.stopPropagation(), e(this).hasClass(q) ? (e(this).removeClass(q), z.removeClass(O), e(this).parent().removeClass(D)) : (P.removeClass(q).parent().removeClass(D), z.removeClass(O), e(this).addClass(q), z.addClass(O), e(this).parent().addClass(D))
        }), H.on("click", function(e) {
            z.removeClass(O), P.removeClass(q), P.parent().removeClass(D)
        }), M = e(".product-list-switcher"), W = e(".product-grid-switcher"), j = e(".product-list-item"), M.on("click", function(e) {
        ...
        }), e(".price-range-from-to").html("Price : <span class='from'>$" + e(".price-range-slider").slider("values", 0) + "</span> &mdash; <span class='to'>$" + e(".price-range-slider").slider("values", 1) + "</span>"), e(".price_range_min").val(e(".price-range-slider").slider("values", 0)), e(".price_range_max").val(e(".price-range-slider").slider("values", 1)), E.ready(function() {
            e('.product-color-choose input[type="radio"]').on("change.symptom", function() {
            ...
            e('.product-select-size input[type="checkbox"]').on("change.symptom", function() {
        ...
        }), e(".product-select-size input[disabled]").parent().addClass("disabled"), e(".product-select-size input[disabled]").addClass("disabled"), e(".comment-form .stars a").on("click", function() {
            e(".comment-form .stars .active").removeClass("active"), e(this).addClass("active")
        }), A = e(".quantity").attr("min"), B = e(".quantity").attr("max"), e(".quantityPlus").on("click", function() {
            var a = parseInt(e(this).prev(".quantity").val(), 10);
            e("p:first").text(), a != parseInt(B, 10) && e(this).prev(".quantity").val(a + 1)
        }), e(".quantityMinus").on("click", function() {
            var a = parseInt(e(this).next(".quantity").val(), 10);
            a != parseInt(A, 10) && e(this).next(".quantity").val(a - 1)
        }),
        function() {
            e(".widget_nav_menu .menu > li:has( > ul )").addClass("main-accordionIcon"), e(".widget_nav_menu .menu > li:has( > ul ) > a").after("<span class='jq-accordionIcon'></span>"), e(".widget_nav_menu .menu > li li:has( > ul ) > a").after("<span class='jq-accordionIcon'></span>"), e(".widget_nav_menu .menu li ul").hide(), e(".widget_nav_menu .menu li .jq-accordionIcon").on("click", function(a) {
                ...
                }), e(".widget_nav_menu .menu ul ul").slideUp(), (a = e(this)).next().is("ul") && a.next().is(":visible") ? a.next().slideUp() : (e(".widget_nav_menu .menu > li:has( > ul )").hasClass("main-accordionIcon is-active") && (e(this).closest(".main-accordionIcon.is-active").children(".jq-accordionIcon").next().is(":visible") || (e(".widget_nav_menu .menu > li.main-accordionIcon.is-active").find("> ul").slideUp(), e(".widget_nav_menu .menu > li.main-accordionIcon.is-active").removeClass("is-active"))), a.next().slideDown())
            });
        ...
        function() {
            if (e(".product-gallery-style3").length) new StickySidebar(".product-page-content", {
                containerSelector: ".product-gallery-style3",
                topSpacing: 90,
                bottomSpacing: 20,
                minWidth: 992
            })
        }(), e('[data-toggle="tooltip"]').tooltip(), e("[data-countdown]").each(function() {
            var a = e(this),
        ...
        }), e(".popup-youtube, .popup-vimeo, .popup-gmaps, .video-popup").magnificPopup({
            disableOn: 700,
            type: "iframe",
            mainClass: "mfp-fade",
            removalDelay: 160,
        ...
        }), e(".mfp-link-popup").magnificPopup({
            type: "image"
        ...
        function() {
            ...
            if (e(s).length) new Isotope(s, {
                layoutMode: "fitRows",
                itemSelector: ".portfolio-item-grid"
            })
        }(), e("#my-map").length && e("#my-map").gMap({
            latitude: 21.17024,
            longitude: 72.831061,
            maptype: "ROADMAP",
            zoom: 13,
