		...
		<table width="90%" border="0" cellspacing="0" cellpadding="0">
			<tr><td align="center">
			    		<span cellpadding="0" cellspacing="0"  style="color: #596167; font-family: Arial, Helvetica, sans-serif; float:left; width:100%; padding:20px;text-align:center; font-size: 13px;">
                                    ...
                                    <h3> <img src="{{asset('frontdesign/images/logo.png')}}"  width="100px" alt="User Image" /> </h3>
                                    <h3>Attire Boutique </h3></font></span>
					</td>
					<td align="right">
				<!--[endif]--><!--
	...
	<tr><td align="center" bgcolor="#fbfcfd">
		...
		<table width="90%" border="0" cellspacing="0" cellpadding="0">
			<tr><td>
			    ...
			    You Have Successfully Created The Order(s) <br/>
			    <br>
            ...
            <td align="center">
                <div cellpadding="0" cellspacing="0"  style="line-height: 24px;">
                	<br>
                     ...
                     <br>
                <small><strong> TRANSACTION ID: {{'tran_id'}}</strong> &nbsp;&nbsp; INVOICE NUMBER: {{invoice_number}}</small>
